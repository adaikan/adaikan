...
<svelte:head>
	<title>Mendaftar Kurir</title>
	<meta name="description" content="Mendaftar Akun Kurir" />
</svelte:head>
				...
				<fieldset>
					...
					<div class="btns">
						...
						<div class="t-center black-text">
							...
							<a class="{$is_desktop ? 'primary-text' : 'white-text'}" href="/courier/entry/login"> Log in </a>
						</div>
					</div>
				</fieldset>
			</form>
