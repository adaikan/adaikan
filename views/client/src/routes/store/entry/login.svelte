...
<script lang="ts">
	...
	async function submit() {
		try {
			...
			alert.hide();
			disableSubmit = true;
			const data = await client.seller.login({
				username,
				password,
			});
			...
			<form on:submit|preventDefault="{submit}">
				<fieldset>
					...
					<div class="btns">
						...
						<div class="t-center">
							<div class="f-14 f-500">Blum Punya Akun?</div>
							<a class="white-text" href="/store/entry/register"> Register </a>
						</div>
					</div>
				</fieldset>
			</form>
