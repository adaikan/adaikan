const { VITE_SERVER_DOMAIN, VITE_API_SERVER_BASE_PATH, VITE_EVENT_SERVER_BASE_PATH, VITE_CLIENT_FETCH_MODE, VITE_WS_SERVER_BASE_PATH, VITE_MAP_KEY } = import.meta.env;
