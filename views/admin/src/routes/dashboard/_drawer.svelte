...
<Appbar class="px-8">
	<section class="w-full h-full relative flex items-center">
		<img src={logo} alt="Logo" width="32" height="32" class="absolute" />
...
<nav class="flex flex-col gap-4">
	<List class="gap-2 px-4">
		...
		<ListItem>
			<a href="{base}/business" class="block">
				<Item
		...
		<ListItem>
			<a href="{base}/server" class="block">
				<Item
		...
		<ListItem>
			<a href="{base}/account" class="block">
				<Item
	...
	<List class="gap-2 px-4">
		<ListItem>
			<a href="{base}/setting" class="block">
				<Item
