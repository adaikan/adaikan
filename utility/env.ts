...
export class EnvConfig {
	public static setup(opts: Options) {
		...
		const appEnv = {
			...
			SERVER_BASE_API_PATH: BASE_API_PATH,
		...
		const clientEnv = {
			...
			VITE_SERVER_BASE_API_PATH: appEnv.SERVER_BASE_API_PATH,
			VITE_WS_SERVER_ORIGIN: appEnv.WS_SERVER_ORIGIN,
